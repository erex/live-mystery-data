...
```{r pdist}
kable(p_dist_table(hn.sex, bins=seq(0,0.6,0.1), proportion=TRUE), 
...
bootout <- bootdht(hn.sex, flatfile=mydata, nboot=299, convert.units = myunits)
```

```{r plotit}
hist(bootout$Nhat, breaks = 15, main="Distribution of bootstrap replicates")
